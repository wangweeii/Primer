...
string badVers(string lettergrade, unsigned grade)
{
        ...
        } // grades ending in 3, 4, 5, 6 will get a minus!
        return lettergrade;
}
...
string rightVers(string lettergrade, unsigned grade)
{
        ...
        {                  // curlies force the else to go with the outer if
                lettergrade += '-';
        } // grades ending in 0, 1, or 2 will get a minus
        return lettergrade;
}
